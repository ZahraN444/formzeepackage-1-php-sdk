...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`?Attributes44`](../../doc/models/attributes-44.md) | Optional | - | getAttributes(): ?Attributes44 | setAttributes(?Attributes44 attributes): void |
...
| `relationships` | [`?TransactionFileSubmissionRelationships`](../../doc/models/transaction-file-submission-relationships.md) | Optional | - | getRelationships(): ?TransactionFileSubmissionRelationships | setRelationships(?TransactionFileSubmissionRelationships relationships): void |
| `type` | [`?string(Type4Enum)`](../../doc/models/type-4-enum.md) | Optional | - | getType(): ?string | setType(?string type): void |
