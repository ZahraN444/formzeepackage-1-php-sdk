...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?TransactionFileSubmission`](../../doc/models/transaction-file-submission.md) | Optional | - | getData(): ?TransactionFileSubmission | setData(?TransactionFileSubmission data): void |
| `links` | [`?TransactionFileLinks`](../../doc/models/transaction-file-links.md) | Optional | - | getLinks(): ?TransactionFileLinks | setLinks(?TransactionFileLinks links): void |
