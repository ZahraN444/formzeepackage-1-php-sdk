...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`?ReportAdmissionAttributes`](../../doc/models/report-admission-attributes.md) | Optional | - | getAttributes(): ?ReportAdmissionAttributes | setAttributes(?ReportAdmissionAttributes attributes): void |
...
| `relationships` | [`?ReportAdmissionRelationships`](../../doc/models/report-admission-relationships.md) | Optional | - | getRelationships(): ?ReportAdmissionRelationships | setRelationships(?ReportAdmissionRelationships relationships): void |
| `type` | [`?string(Type11Enum)`](../../doc/models/type-11-enum.md) | Optional | - | getType(): ?string | setType(?string type): void |
