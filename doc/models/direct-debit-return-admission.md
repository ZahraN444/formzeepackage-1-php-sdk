...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`Attributes32`](../../doc/models/attributes-32.md) | Required | - | getAttributes(): Attributes32 | setAttributes(Attributes32 attributes): void |
...
| `relationships` | [`?DirectDebitReturnAdmissionRelationships`](../../doc/models/direct-debit-return-admission-relationships.md) | Optional | - | getRelationships(): ?DirectDebitReturnAdmissionRelationships | setRelationships(?DirectDebitReturnAdmissionRelationships relationships): void |
