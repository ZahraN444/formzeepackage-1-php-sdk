...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`?Attributes38`](../../doc/models/attributes-38.md) | Optional | - | getAttributes(): ?Attributes38 | setAttributes(?Attributes38 attributes): void |
| `createdOn` | `?DateTime` | Optional | - | getCreatedOn(): ?\DateTime | setCreatedOn(?\DateTime createdOn): void |
| `id` | `string` | Required | Unique ID | getId(): string | setId(string id): void |
...
| `relationships` | [`?DirectDebitSubmissionRelationships`](../../doc/models/direct-debit-submission-relationships.md) | Optional | - | getRelationships(): ?DirectDebitSubmissionRelationships | setRelationships(?DirectDebitSubmissionRelationships relationships): void |
| `type` | `?string` | Optional | Name of the resource type<br>**Constraints**: *Pattern*: `^[A-Za-z_]*$` | getType(): ?string | setType(?string type): void |
| `version` | `?int` | Optional | Version of the resource<br>**Constraints**: `>= 0` | getVersion(): ?int | setVersion(?int version): void |
