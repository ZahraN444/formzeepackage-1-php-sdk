...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`Report`](../../doc/models/report.md) | Required | - | getData(): Report | setData(Report data): void |
| `links` | [`?ReportLinks`](../../doc/models/report-links.md) | Optional | - | getLinks(): ?ReportLinks | setLinks(?ReportLinks links): void |
