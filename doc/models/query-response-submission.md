...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`QueryResponseSubmissionAttributes`](../../doc/models/query-response-submission-attributes.md) | Required | - | getAttributes(): QueryResponseSubmissionAttributes | setAttributes(QueryResponseSubmissionAttributes attributes): void |
...
| `relationships` | [`?QueryResponseSubmissionRelationships`](../../doc/models/query-response-submission-relationships.md) | Optional | - | getRelationships(): ?QueryResponseSubmissionRelationships | setRelationships(?QueryResponseSubmissionRelationships relationships): void |
