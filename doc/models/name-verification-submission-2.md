...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(NameVerificationSubmission[])`](../../doc/models/name-verification-submission.md) | Optional | **Constraints**: *Minimum Items*: `0`, *Maximum Items*: `1` | getData(): ?array | setData(?array data): void |
