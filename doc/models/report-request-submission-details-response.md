...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`ReportRequestSubmission`](../../doc/models/report-request-submission.md) | Required | - | getData(): ReportRequestSubmission | setData(ReportRequestSubmission data): void |
| `links` | [`Links`](../../doc/models/links.md) | Required | - | getLinks(): Links | setLinks(Links links): void |
