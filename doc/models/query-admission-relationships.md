...
|  --- | --- | --- | --- | --- | --- |
| `query` | [`RelationshipsFullQuery`](../../doc/models/relationships-full-query.md) | Required | - | getQuery(): RelationshipsFullQuery | setQuery(RelationshipsFullQuery query): void |
