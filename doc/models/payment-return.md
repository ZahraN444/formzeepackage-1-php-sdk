...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(ReturnPayment[])`](../../doc/models/return-payment.md) | Optional | Array of Payment Return resources related to the payment | getData(): ?array | setData(?array data): void |
