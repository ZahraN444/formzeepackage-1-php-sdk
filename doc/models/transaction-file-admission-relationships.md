...
|  --- | --- | --- | --- | --- | --- |
| `transactionFiles` | [`?TransactionFiles`](../../doc/models/transaction-files.md) | Optional | - | getTransactionFiles(): ?TransactionFiles | setTransactionFiles(?TransactionFiles transactionFiles): void |
