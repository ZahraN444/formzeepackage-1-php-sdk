...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(ReturnAdmission[])`](../../doc/models/return-admission.md) | Optional | Array of Return Admission resources related to the return | getData(): ?array | setData(?array data): void |
