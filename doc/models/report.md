...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`ReportAttributes`](../../doc/models/report-attributes.md) | Required | - | getAttributes(): ReportAttributes | setAttributes(ReportAttributes attributes): void |
...
| `relationships` | [`?ReportRelationships`](../../doc/models/report-relationships.md) | Optional | - | getRelationships(): ?ReportRelationships | setRelationships(?ReportRelationships relationships): void |
| `type` | [`?string(Type13Enum)`](../../doc/models/type-13-enum.md) | Optional | - | getType(): ?string | setType(?string type): void |
