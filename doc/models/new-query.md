...
|  --- | --- | --- | --- | --- | --- |
| `attributes` | [`QueryAttributes`](../../doc/models/query-attributes.md) | Required | - | getAttributes(): QueryAttributes | setAttributes(QueryAttributes attributes): void |
| `id` | `string` | Required | - | getId(): string | setId(string id): void |
| `organisationId` | `string` | Required | - | getOrganisationId(): string | setOrganisationId(string organisationId): void |
| `relationships` | [`?NewQueryRelationships`](../../doc/models/new-query-relationships.md) | Optional | - | getRelationships(): ?NewQueryRelationships | setRelationships(?NewQueryRelationships relationships): void |
