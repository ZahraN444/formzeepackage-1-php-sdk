...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(PaymentAdmission[])`](../../doc/models/payment-admission.md) | Optional | Array of Payment Admission resources related to the payment | getData(): ?array | setData(?array data): void |
