...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(PaymentSubmission[])`](../../doc/models/payment-submission.md) | Optional | Array of Payment Submission resources related to the payment | getData(): ?array | setData(?array data): void |
