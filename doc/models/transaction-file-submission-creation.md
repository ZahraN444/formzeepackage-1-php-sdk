...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`TransactionFileSubmission`](../../doc/models/transaction-file-submission.md) | Required | - | getData(): TransactionFileSubmission | setData(TransactionFileSubmission data): void |
