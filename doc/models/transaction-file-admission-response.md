...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?TransactionFileAdmission`](../../doc/models/transaction-file-admission.md) | Optional | - | getData(): ?TransactionFileAdmission | setData(?TransactionFileAdmission data): void |
