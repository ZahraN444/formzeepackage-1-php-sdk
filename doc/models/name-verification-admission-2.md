...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?(NameVerificationAdmission[])`](../../doc/models/name-verification-admission.md) | Optional | **Constraints**: *Minimum Items*: `0`, *Maximum Items*: `1` | getData(): ?array | setData(?array data): void |
