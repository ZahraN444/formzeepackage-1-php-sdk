...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`?SchemeFileSubmission`](../../doc/models/scheme-file-submission.md) | Optional | - | getData(): ?SchemeFileSubmission | setData(?SchemeFileSubmission data): void |
| `links` | [`?SchemeFileLinks`](../../doc/models/scheme-file-links.md) | Optional | - | getLinks(): ?SchemeFileLinks | setLinks(?SchemeFileLinks links): void |
