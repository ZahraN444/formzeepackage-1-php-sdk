...
|  --- | --- | --- | --- | --- | --- |
| `data` | [`TransactionFileAdmission`](../../doc/models/transaction-file-admission.md) | Required | - | getData(): TransactionFileAdmission | setData(TransactionFileAdmission data): void |
