...
|  --- | --- | --- | --- | --- | --- |
| `query` | [`?RelationshipsFullQuery`](../../doc/models/relationships-full-query.md) | Optional | - | getQuery(): ?RelationshipsFullQuery | setQuery(?RelationshipsFullQuery query): void |
| `queryResponseAdmission` | [`?RelationshipQueryResponseAdmission`](../../doc/models/relationship-query-response-admission.md) | Optional | - | getQueryResponseAdmission(): ?RelationshipQueryResponseAdmission | setQueryResponseAdmission(?RelationshipQueryResponseAdmission queryResponseAdmission): void |
| `queryResponseSubmission` | [`?RelationshipQueryResponseSubmission`](../../doc/models/relationship-query-response-submission.md) | Optional | - | getQueryResponseSubmission(): ?RelationshipQueryResponseSubmission | setQueryResponseSubmission(?RelationshipQueryResponseSubmission queryResponseSubmission): void |
