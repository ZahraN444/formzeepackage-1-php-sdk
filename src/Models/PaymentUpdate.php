...
class PaymentUpdate implements \JsonSerializable
{
    /**
    ...
    /**
     * @var PaymentUpdateRelationships|null
     */
     ...
     * @param int $version
     */
    public function __construct(PaymentAttributes $attributes, string $id, string $organisationId, int $version)
    {
     ...
     * @maps attributes
     */
    public function setAttributes(PaymentAttributes $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?PaymentUpdateRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?PaymentUpdateRelationships $relationships): void
    {
