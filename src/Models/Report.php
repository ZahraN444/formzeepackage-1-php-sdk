...
class Report implements \JsonSerializable
{
     ...
     */
    public function __construct(ReportAttributes $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): ReportAttributes
    {
     ...
     * @maps attributes
     */
    public function setAttributes(ReportAttributes $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?ReportRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?ReportRelationships $relationships): void
    {
     ...
     *
     * @maps type
     * @factory \Form3PublicAPILib\Models\Type13Enum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->type)) {
            $json['type']          = Type13Enum::checkValue($this->type);
        }
