...
class AccountAttributes implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @var string|null
     */
    private $accountClassification = AccountClassification1Enum::PERSONAL;

    /**
     * @var bool|null
     */
    private $accountMatchingOptOut = false;
     ...
     * @var string|null
     */
    private $nameMatchingStatus = NameMatchingStatusEnum::SUPPORTED;
