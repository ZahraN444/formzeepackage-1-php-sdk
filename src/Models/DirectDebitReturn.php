...
class DirectDebitReturn implements \JsonSerializable
{
    /**
     * @var Attributes31
     */
    ...
    /**
     * @param Attributes31 $attributes
     * @param string $id
     * @param string $organisationId
     */
    public function __construct(Attributes31 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes31
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes31 $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?Relationships10
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?Relationships10 $relationships): void
    {
