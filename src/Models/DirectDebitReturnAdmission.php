...
class DirectDebitReturnAdmission implements \JsonSerializable
{
    /**
     * @var Attributes32
     */
    ...
    /**
     * @var DirectDebitReturnAdmissionRelationships|null
     */
    ...
    /**
     * @param Attributes32 $attributes
     * @param string $id
     * @param string $organisationId
     */
    public function __construct(Attributes32 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes32
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes32 $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?DirectDebitReturnAdmissionRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?DirectDebitReturnAdmissionRelationships $relationships): void
    {
