...
class ReportAdmissionAttributes implements \JsonSerializable
{
    /**
     * @var \DateTime|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\ReportAdmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         = ReportAdmissionStatusEnum::checkValue($this->status);
        }
