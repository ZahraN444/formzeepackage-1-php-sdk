...
/**
 * Builder for model QueryUltimateEntity
 *
 * @see QueryUltimateEntity
 */
class QueryUltimateEntityBuilder
{
    /**
     * @var QueryUltimateEntity
     */
    private $instance;

    private function __construct(QueryUltimateEntity $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new query ultimate entity Builder object.
     */
    public static function init(): self
    {
        return new self(new QueryUltimateEntity());
    }
    ...
    /**
     * Initializes a new query ultimate entity object.
     */
    public function build(): QueryUltimateEntity
    {
