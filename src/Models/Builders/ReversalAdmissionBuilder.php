...
/**
 * Builder for model ReversalAdmission
 *
 * @see ReversalAdmission
 */
class ReversalAdmissionBuilder
{
    /**
     * @var ReversalAdmission
     */
    private $instance;

    private function __construct(ReversalAdmission $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new reversal admission Builder object.
     */
    public static function init(string $id, string $organisationId): self
    {
        return new self(new ReversalAdmission($id, $organisationId));
    }
     ...
     */
    public function relationships(?Relationships4 $value): self
    {
    ...
    /**
     * Initializes a new reversal admission object.
     */
    public function build(): ReversalAdmission
    {
