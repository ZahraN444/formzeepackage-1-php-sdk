...
/**
 * Builder for model ReimbursementAccountHoldingEntity
 *
 * @see ReimbursementAccountHoldingEntity
 */
class ReimbursementAccountHoldingEntityBuilder
{
    /**
     * @var ReimbursementAccountHoldingEntity
     */
    private $instance;

    private function __construct(ReimbursementAccountHoldingEntity $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new reimbursement account holding entity Builder object.
     */
    public static function init(): self
    {
        return new self(new ReimbursementAccountHoldingEntity());
    }
    ...
    /**
     * Initializes a new reimbursement account holding entity object.
     */
    public function build(): ReimbursementAccountHoldingEntity
    {
