...
/**
 * Builder for model PaymentUpdateRelationships
 *
 * @see PaymentUpdateRelationships
 */
class PaymentUpdateRelationshipsBuilder
{
    /**
     * @var PaymentUpdateRelationships
     */
    private $instance;

    private function __construct(PaymentUpdateRelationships $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new payment update relationships Builder object.
     */
    public static function init(): self
    {
        return new self(new PaymentUpdateRelationships());
    }
     ...
     */
    public function forwardingPayment(?ForwardingPayment1 $value): self
    {
    ...
    /**
     * Initializes a new payment update relationships object.
     */
    public function build(): PaymentUpdateRelationships
    {
