...
/**
 * Builder for model BeneficiaryParty1
 *
 * @see BeneficiaryParty1
 */
class BeneficiaryParty1Builder
{
    /**
     * @var BeneficiaryParty1
     */
    private $instance;

    private function __construct(BeneficiaryParty1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new beneficiary party 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new BeneficiaryParty1());
    }
    ...
    /**
     * Initializes a new beneficiary party 1 object.
     */
    public function build(): BeneficiaryParty1
    {
