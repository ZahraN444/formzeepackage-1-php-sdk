...
class NewPayment implements \JsonSerializable
{
    /**
    ...
    /**
     * @var NewPaymentRelationships|null
     */
     ...
     */
    public function __construct(PaymentAttributes $attributes, string $id, string $organisationId)
    {
     ...
     */
    public function getRelationships(): ?NewPaymentRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?NewPaymentRelationships $relationships): void
    {
