...
class Attributes32 implements \JsonSerializable
{
    /**
     * @var \DateTime|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\DirectDebitReturnAdmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         = DirectDebitReturnAdmissionStatusEnum::checkValue($this->status);
        }
