...
class DirectDebitReversalAdmission implements \JsonSerializable
{
    /**
     * @var Attributes36
     */
    ...
    /**
     * @param Attributes36 $attributes
     * @param string $id
     * @param string $organisationId
     */
    public function __construct(Attributes36 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes36
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes36 $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?Relationships15
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?Relationships15 $relationships): void
    {
