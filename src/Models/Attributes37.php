...
class Attributes37 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\DirectDebitReversalSubmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         =
                DirectDebitReversalSubmissionStatusEnum::checkValue(
                    $this->status
                );
        }
