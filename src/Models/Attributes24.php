...
class Attributes24 implements \JsonSerializable
{
    /**
     * @var \DateTime|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\DirectDebitAdmissionStatusEnum::checkValue
     */
     ...
     *
     * @maps status_reason
     * @factory \Form3PublicAPILib\Models\DirectDebitAdmissionStatusReasonEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         = DirectDebitAdmissionStatusEnum::checkValue($this->status);
        }
        if (isset($this->statusReason)) {
            $json['status_reason']                  =
                DirectDebitAdmissionStatusReasonEnum::checkValue(
                    $this->statusReason
                );
        }
