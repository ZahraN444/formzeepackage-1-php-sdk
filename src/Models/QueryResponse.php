...
class QueryResponse implements \JsonSerializable
{
    ...
    /**
     * @var QueryResponseRelationships|null
     */
     ...
     * @param int $version
     */
    public function __construct(QueryResponseAttributes $attributes, string $id, string $organisationId, int $version)
    {
     ...
     */
    public function getRelationships(): ?QueryResponseRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?QueryResponseRelationships $relationships): void
    {
