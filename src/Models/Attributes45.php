...
class Attributes45 implements \JsonSerializable
{
    /**
     * @var \DateTime|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\MandateAdmissionStatusEnum::checkValue
     */
     ...
     *
     * @maps status_reason
     * @factory \Form3PublicAPILib\Models\MandateAdmissionStatusReasonEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         = MandateAdmissionStatusEnum::checkValue($this->status);
        }
        if (isset($this->statusReason)) {
            $json['status_reason']                  = MandateAdmissionStatusReasonEnum::checkValue($this->statusReason);
        }
