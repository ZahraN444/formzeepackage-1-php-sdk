...
class SubscriptionDeliveryError implements \JsonSerializable
{
    /**
     * @var Attributes69|null
     */
    private $attributes;
     ...
     * Returns Attributes.
     */
    public function getAttributes(): ?Attributes69
    {
     ...
     * @maps attributes
     */
    public function setAttributes(?Attributes69 $attributes): void
    {
     ...
     */
    public function getRelationships(): ?Relationships25
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?Relationships25 $relationships): void
    {
     ...
     *
     * @maps type
     * @factory \Form3PublicAPILib\Models\SubscriptionDeliveryErrorTypeEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->type)) {
            $json['type']            = SubscriptionDeliveryErrorTypeEnum::checkValue($this->type);
        }
