...
class PaymentAdvice implements \JsonSerializable
{
    /**
     * @var Attributes3|null
     */
    private $attributes;
     ...
     * Returns Attributes.
     */
    public function getAttributes(): ?Attributes3
    {
     ...
     * @maps attributes
     */
    public function setAttributes(?Attributes3 $attributes): void
    {
     ...
     */
    public function getRelationships(): ?Relationships1
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?Relationships1 $relationships): void
    {
