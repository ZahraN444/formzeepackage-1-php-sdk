...
class Attributes47 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\MandateReturnSubmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                     = MandateReturnSubmissionStatusEnum::checkValue($this->status);
        }
