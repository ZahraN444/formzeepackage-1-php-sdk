...
class Claim implements \JsonSerializable
{
     ...
     */
    public function __construct(ClaimAttributes $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): ClaimAttributes
    {
     ...
     * @maps attributes
     */
    public function setAttributes(ClaimAttributes $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?ClaimRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?ClaimRelationships $relationships): void
    {
