...
class QueryBeneficiaryDebtorParty implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var QueryBeneficiaryDebtorAccountProxy|null
     */
    private $accountProxy;

    /**
     * @var AccountWith|null
     */
    private $accountWith;
     ...
     * @factory \Form3PublicAPILib\Models\QueryAccountNumberCodeEnum::checkValue
     */
     ...
     */
    public function getAccountProxy(): ?QueryBeneficiaryDebtorAccountProxy
    {
     ...
     * @maps account_proxy
     */
    public function setAccountProxy(?QueryBeneficiaryDebtorAccountProxy $accountProxy): void
    {
     ...
     */
    public function getAccountWith(): ?AccountWith
    {
     ...
     * @maps account_with
     */
    public function setAccountWith(?AccountWith $accountWith): void
    {
     ...
     * Organisation identification of a debtor/beneficiary, in the case that the debtor/beneficiary is an
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->accountNumberCode)) {
            $json['account_number_code']                =
                QueryAccountNumberCodeEnum::checkValue(
                    $this->accountNumberCode
                );
        }
