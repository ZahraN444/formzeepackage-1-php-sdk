...
class Attributes38 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\DirectDebitSubmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']                         = DirectDebitSubmissionStatusEnum::checkValue($this->status);
        }
