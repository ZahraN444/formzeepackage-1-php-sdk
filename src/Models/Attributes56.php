...
class Attributes56 implements \JsonSerializable
{
    /**
     * @var \DateTime|null
     */
     ...
     *
     * @maps status
     * @factory \Form3PublicAPILib\Models\RecallAdmissionStatusEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->status)) {
            $json['status']             = RecallAdmissionStatusEnum::checkValue($this->status);
        }
