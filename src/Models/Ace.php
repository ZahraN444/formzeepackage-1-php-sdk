...
class Ace implements \JsonSerializable
{
     ...
     */
    public function __construct(Attributes2 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes2
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes2 $attributes): void
    {
        $this->attributes = $attributes;
    }
