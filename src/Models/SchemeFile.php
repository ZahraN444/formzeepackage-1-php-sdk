...
class SchemeFile implements \JsonSerializable
{
    /**
     * @var Attributes39
     */
    ...
    /**
     * @var SchemeFileRelationships|null
     */
    ...
    /**
     * @param Attributes39 $attributes
     * @param string $id
     * @param string $organisationId
     */
    public function __construct(Attributes39 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes39
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes39 $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?SchemeFileRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?SchemeFileRelationships $relationships): void
    {
     ...
     *
     * @maps type
     * @factory \Form3PublicAPILib\Models\Type2Enum::checkValue
     */
