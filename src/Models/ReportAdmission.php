...
class ReportAdmission implements \JsonSerializable
{
    /**
     * @var ReportAdmissionAttributes|null
     */
    private $attributes;
    ...
    /**
     * @var ReportAdmissionRelationships|null
     */
     ...
     * Returns Attributes.
     */
    public function getAttributes(): ?ReportAdmissionAttributes
    {
     ...
     * @maps attributes
     */
    public function setAttributes(?ReportAdmissionAttributes $attributes): void
    {
     ...
     */
    public function getRelationships(): ?ReportAdmissionRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?ReportAdmissionRelationships $relationships): void
    {
     ...
     *
     * @maps type
     * @factory \Form3PublicAPILib\Models\Type11Enum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->type)) {
            $json['type']          = Type11Enum::checkValue($this->type);
        }
