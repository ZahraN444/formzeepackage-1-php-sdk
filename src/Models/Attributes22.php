...
class Attributes22 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    private $schemeMessageId;
    ...
    /**
     * Returns Scheme Message Id.
     */
    public function getSchemeMessageId(): ?string
    {
        return $this->schemeMessageId;
    }

    /**
     * Sets Scheme Message Id.
     *
     * @maps scheme_message_id
     */
    public function setSchemeMessageId(?string $schemeMessageId): void
    {
    ...
    {
        $json = [];
        if (isset($this->schemeMessageId)) {
            $json['scheme_message_id']   = $this->schemeMessageId;
        }
