...
class DirectDebitDecisionAdmission implements \JsonSerializable
{
    /**
     * @var Attributes26
     */
    ...
    /**
     * @var DirectDebitDecisionAdmissionRelationships|null
     */
    ...
    /**
     * @param Attributes26 $attributes
     * @param string $id
     * @param string $organisationId
     */
    public function __construct(Attributes26 $attributes, string $id, string $organisationId)
    {
     ...
     * Returns Attributes.
     */
    public function getAttributes(): Attributes26
    {
     ...
     * @maps attributes
     */
    public function setAttributes(Attributes26 $attributes): void
    {
        $this->attributes = $attributes;
    }
     ...
     */
    public function getRelationships(): ?DirectDebitDecisionAdmissionRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?DirectDebitDecisionAdmissionRelationships $relationships): void
    {
