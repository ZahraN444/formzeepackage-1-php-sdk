...
class Query implements \JsonSerializable
{
     ...
     * @param int $version
     */
    public function __construct(QueryAttributes $attributes, string $id, string $organisationId, int $version)
    {
     ...
     */
    public function getRelationships(): ?QueryRelationships
    {
     ...
     * @maps relationships
     */
    public function setRelationships(?QueryRelationships $relationships): void
    {
