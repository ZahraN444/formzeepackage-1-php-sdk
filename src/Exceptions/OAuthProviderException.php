...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \Form3PublicAPILib\Http\HttpRequest $request
     * @param \Form3PublicAPILib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \Form3PublicAPILib\Http\HttpRequest $request,
        \Form3PublicAPILib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \Form3PublicAPILib\Models\OAuthProviderErrorEnum::checkValue
     */
