...
class Form3PublicAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function basicCredentials(BasicCredentialsBuilder $basic): self
    {
        $this->config = array_merge($this->config, $basic->getConfiguration());
        return $this;
    }
    ...
    public function build(): Form3PublicAPIClient
    {
        return new Form3PublicAPIClient($this->config);
    }
}
